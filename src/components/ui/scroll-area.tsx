...
function ScrollBar({
  ...
  return (
    <ScrollAreaPrimitive.ScrollAreaScrollbar
      ...
      className={cn(
        "bg-muted/60 z-30 flex touch-none p-px transition-colors select-none",
        orientation === "vertical" &&
    ...
    >
      <ScrollAreaPrimitive.ScrollAreaThumb
        ...
        className="bg-muted-foreground/70 hover:bg-primary relative flex-1 rounded-full transition-colors"
      />
    </ScrollAreaPrimitive.ScrollAreaScrollbar>
  )
}
